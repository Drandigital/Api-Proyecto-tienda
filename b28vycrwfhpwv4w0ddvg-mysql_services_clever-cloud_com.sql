...
INSERT INTO `bodega` (`id`, `id_empresa`, `nombre`, `descripcion`, `id_user`) VALUES
(2, 1, 'prueba 2', 'sadlasjdlksajdlas', 1),
(3, 1, 'prueva 3', 'sadsadsadasd', 1);
...
(2, 2, 'Venta', 'Venta', 'la la-calculator'),
(3, 9, 'Configuracion', 'Configuracion', 'la la-cogs'),
(4, 4, 'Inventario', 'Inventario', 'la la-cogs');
...
('026', 'Armenia', 'Armenia', 'Arménie', 'AM', 'ARM', '374', ''),
...
('074', 'Azerbayán', 'Azerbaijan', 'Azerbaïdjan', 'AZ', 'AZE', '994', ''),
...
('193', 'Costa de Marfil', 'Ivory Coast', 'Ivoire', 'CI', 'CIV', '225', ''),
...
('249', 'Estados Unidos de América', 'United States of America', 'Amérique', 'US', 'USA', '1', ''),
('251', 'Estonia', 'Estonia', 'Estonie', 'EE', 'EST', '372', ''),
...
('601', 'Antártida', 'Antarctica', ' Antarctique', 'AQ', 'ATA', '672', ''),
...
('787', 'Territorio Británico del Océano Índico', 'British Indian Ocean Territory', 'Territoire britannique de  océan Indien', 'IO', 'IOT', '', ''),
...
('830', 'Ucrania', 'Ukraine', ' Ukraine', 'UA', 'UKR', '380', ''),
('833', 'Uganda', 'Uganda', 'Ouganda', 'UG', 'UGA', '256', ''),
('845', 'Uruguay', 'Uruguay', 'Uruguay', 'UY', 'URY', '598', ''),
('847', 'Uzbekistán', 'Uzbekistan', ' Ouzbékistan', 'UZ', 'UZB', '998', ''),
...
(3, 4, 2, 'orden de compra', 'orden de compra', 'la la-calculator', b'1', NULL, 'InformacionGeneral.html', NULL, '|G|C|E|N|'),
(4, 4, 1, 'Facturación', 'Facturación', NULL, b'1', NULL, 'facturacion.html', NULL, '|G|C|E|N|'),
(5, 3, 3, 'Roles', 'Roles', 'la la-calculator', b'1', NULL, 'views/Configuracion/Roles/Roles.html', NULL, '|N|G|E|C|');

-- --------------------------------------------------------

--
-- Table structure for table `submenuopcion`
--
...
--
-- Dumping data for table `submenuopcion`
--
...
--
-- Indexes for table `submenuopcion`
--
...
--
-- AUTO_INCREMENT for table `submenuopcion`
--
ALTER TABLE `submenuopcion`
